...
Route::group(['middleware' => ['provider.api']], function () {
    ...
    Route::get('documents', 'Provider\DocumentController@index');
    Route::post('documents/{id}', 'Provider\DocumentController@uploadDocument');
    Route::get('documents/status', 'Provider\DocumentController@checkSubmittedDocuments');

    Route::get('/target', 'ProviderResources\ProfileController@target');
    Route::get('/servicelist', 'ProviderResources\ProfileController@servicelist');
    Route::post('/updateservice', 'ProviderResources\ProfileController@updateservice');
