...
Route::post('/vehicle_seats', 'UserApiController@get_vehicle_seats');

// otp verification
Route::post('otp', 'OtpController@sendOtp')->name('send_otp');
Route::post('otp/check', 'OtpController@verifyOtp')->name('check_otp');
...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::get('/vehicle_types', 'UserApiController@get_vehicle_types');
