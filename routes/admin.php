...
Route::resource('rides', 'Admin\RideTypeController');
Route::resource('outstations', 'Admin\OutstationController');
Route::resource('outstations_prices', 'Admin\OutstationPriceController');
...
Route::group(['as' => 'provider.'], function () {
    ...
    Route::post('provider/{provider}/ride', 'Admin\RideTypeController@assignRide')->name('assign_ride');
    Route::delete('provider/{provider}/ride/{ride_type}', 'Admin\RideTypeController@deleteAssignRide')->name('delete_assign_ride');
...
Route::get('/payout', 'AdminController@payout_details')->name('payout');
Route::get('/payout_details/{id}', 'AdminController@payout_details_for_one')->name('payout_details');
