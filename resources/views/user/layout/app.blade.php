        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
               ...
               {{--  <li class="white-border">
                    <a href="{{ url('/provider/login') }}">BECOME A AFFILIATE</a>
                </li> --}}
                <li>
                ...
                <nav class="navbar navbar-fixed-top">
                    <div class="container-fluid" style="background-color:#660066;">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="{{url('/')}}">  <img src="{{ asset('logo.png') }}"  > </a>
                        </div>
                        <div class="collapse navbar-collapse"  id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="{{ url('contacts') }}">Help</a></li>
                                <li><a href="{{url('/login')}}">Sign in</a></li>
                             {{--    <li><a class="menu-btn" href="{{url('/provider/register')}}">Become a Affiliate</a></li> --}}
                            </ul>
                        </div>
                    </div>
                </nav>
                        ...
                        <div class="row no-margin">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
                                    ...
                                    <li><a href="{{ url('contacts') }}">Cities</a></li>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
                                    ...
                                    {{-- <li><a href="{{url('drive')}}">Become a AFFILIATE</a></li> --}}
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">                        
                               <h5>Connect us</h5>
                                <ul class="social">
                                    <li><a href="https://www.facebook.com/swiftwheelsgh" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/swiftwheelsgh" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="https://www.instagram.com/swiftwheelsgh/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
