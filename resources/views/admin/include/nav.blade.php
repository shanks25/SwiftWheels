        ...
        <ul class="sidebar-menu">
            ...
            <li class="with-sub">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.dispatch-manager.create') }}">@lang('admin.include.add_new_dispatcher')</a>
                    </li>
                </ul>
            </li>
            <li class="with-sub">
            ...
            <li class="with-sub">
                ...
                <ul>
                    <li>
                        <a href="{{ route('admin.account-manager.index') }}">@lang('admin.include.list_account_managers')</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.account-manager.create') }}">@lang('admin.include.add_new_account_manager')</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="with-sub">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.ride.statement.provider') }}">@lang('admin.include.provider_statement')</a>
                    </li>
                    <li><a href="{{ route('admin.ride.statement.today') }}">@lang('admin.include.daily_statement')</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.ride.statement.monthly') }}">@lang('admin.include.monthly_statement')</a>
                    </li>
            ...
            <li class="with-sub">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('admin.rides.index') }}">@lang('admin.include.list_rides_types')</a></li>
            ...
            <li class="with-sub">
                <a href="#" class="waves-effect  waves-light">
                    <span class="s-caret"><i class="fa fa-angle-down"></i></span>
                    <span class="s-icon"><i class="ti-target"></i></span>
                    <span class="s-text">OutStations</span>
                </a>
                <ul>
                    <li><a href="{{ route('admin.outstations.index') }}">Out Stations</a></li>
                    <li><a href="{{ route('admin.outstations_prices.index') }}">Out Stations Prices</a></li>
                    </li>
                </ul>
            </li>
            <li class="with-sub">
            ...
            <!-- Payout in sidebar starts -->
            <li>
                <a href="{{ route('admin.payout') }}" class="waves-effect  waves-light">
                    <span class="s-icon"><i class="ti-palette"></i></span>
                    <span class="s-text">Payout</span>
                </a>
            </li>
            <!-- Payout in sidebar ends -->
