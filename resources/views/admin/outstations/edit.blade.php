    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <h5 style="margin-bottom: 2em;">Update Outstation</h5>

                <form class="form-horizontal" action="{{route('admin.outstations.update', $outstation->id )}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="{{ $outstation->name }}" name="name" required
                                   id="name" placeholder="OutStation Name">
                        </div>
                    </div>

                    <input type="hidden" id="place" name="place" value="{{ $outstation->place }}">
                    <input type="hidden" id="latitude" name="latitude" value="{{ $outstation->latitude }}">
                    <input type="hidden" id="longitude" name="longitude" value="{{ $outstation->longitude }}">
                        ...
                        <div class="col-xs-10">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                                    <button type="submit" class="btn btn-primary btn-block">Update OutStation</button>
                                </div>
                            </div>
                        </div>
                    </div>
