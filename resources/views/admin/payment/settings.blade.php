            ...
            <form action="{{route('admin.settings.payment.store')}}" method="POST">
                ...
                <div class="card card-block card-inverse card-info">
                    <blockquote class="card-blockquote">
                        ...
                        <div class="form-group row">
                            <label for="commission_percentage" class="col-xs-4 col-form-label">Affiliate Commission(%)</label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                        ...
                        <div class="form-group row">
                            <label for="provider_commission_percentage" class="col-xs-4 col-form-label"> Admin Commission (%)</label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                            ...
                            <div class="col-xs-8">
                                <select name="currency" class="form-control" required>
                                    ...
                                    <option @if(Setting::get('currency') == "AU$") selected @endif value="AU$"> Australian Dollar (AUD)</option>
                                       <option @if(Setting::get('currency') == "AU$") selected @endif value="GHS"> Ghana (GHS)</option>
                                </select>
                            </div>
                        </div>
                    </blockquote>
