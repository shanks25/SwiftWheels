            ...
            <div class="box box-block bg-white">
                ...
                <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="number" value="{{ old('capacity') }}" name="capacity"
                                   required id="capacity" placeholder="Capacity">
                        </div>
                    </div>
                    ...
                    @foreach($ride_types as $ride_type)
                        ...
                        <h1>Service type charges for {{ $ride_type->name }}.</h1>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-10">
                                <input class="form-control" type="text" value="{{ old('fixed') }}"
                                       name="{{ $ride_type->id }}_fixed" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-10">
                                <input class="form-control" type="text" value="{{ old('minute') }}"
                                       name="{{ $ride_type->id }}_minute"
                                       required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-10">
                                <input class="form-control" type="text" value="{{ old('price') }}"
                                       name="{{ $ride_type->id }}_price" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-10">
                                <input class="form-control" type="text" value="{{ old('distance') }}"
                                       name="{{ $ride_type->id }}_max_distance"
                        ...
                        <div class="form-group row">
                            <label for="price" class="col-xs-12 col-form-label">@lang('admin.service.Max_Price')
                                ({{ currency() }})</label>
                            <div class="col-xs-10">
                                <input class="form-control" type="text" value="{{ old('max_distance_price') }}"
                                       name="{{ $ride_type->id }}_max_distance_price" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-10">
                                <select class="form-control" id="calculator" name="{{ $ride_type->id }}_calculator">
