...
upfront bookings, loyal riders etc.
    ...
    <div class="row gray-section no-margin full-section">
        <div class="container">
            <div class="col-md-6 content-block">
                ...
                <div class="title-divider"></div>
                <p>What makes the {{ Setting::get('site_title', 'Tranxit') }} experience truly great are the people
                ...
                <a class="content-more-btn" href="#">WHY DRIVE WITH {{ Setting::get('site_title', 'Tranxit')  }} <i
                            class="fa fa-chevron-right"></i></a>
            </div>
            <div class="col-md-6 full-img text-center"
                 style="background-image: url({{ asset('asset/img/behind-the-wheel.jpg') }});">
    ...
    <div class="row white-section no-margin">
        <div class="container">
            ...
            <div class="col-md-6 content-block">
                ...
                <div class="title-divider"></div>
                <p>A city with {{ Setting::get('site_title', 'Tranxit') }} has more economic opportunities for
    ...
    <div class="row find-city no-margin">
        <div class="container">
            <h2>{{ Setting::get('site_title','Tranxit') }} is in Ghana.</h2>
            <form>
    ...
    <div class="footer-city row no-margin"
         style="background-image: url({{ asset('asset/img/footer-city.png') }});"></div>
