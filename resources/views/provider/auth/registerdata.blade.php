...
<div class="col-md-12">
    <form class="form-horizontal" role="form" method="POST" action="{{ url('provider/register') }}">
        ...
        <div id="first_step">
            <div class="col-md-4">
                <input value="+91" type="hidden" placeholder="+91" id="country_code" name="country_code"/>
            </div>
        ...
        <div id="second_step">
            ...
            placeholder="phone_number Address" value="{{session()->get('providerid')['phone_number']}}" readonly>
