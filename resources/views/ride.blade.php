        ...
        <div class="container">                
            ...
            <div class="car-tab">
                <ul class="nav nav-tabs">
                  <li class="active"><a data-toggle="tab" href="#economy">SwiftGo</a></li>
                  <li><a data-toggle="tab" href="#premium">Ridewithme</a></li>
                  <li><a data-toggle="tab" href="#accessibility">SwiftTaxi</a></li>
                  <li><a data-toggle="tab" href="#carpool">Paddyride</a></li>
                </ul>
