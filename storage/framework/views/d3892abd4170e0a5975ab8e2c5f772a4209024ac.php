    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('/provider')); ?>"><img src="<?php echo e(Setting::get('site_logo', asset('logo-black.png'))); ?>"></a>
            </div>
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu">
                            <li class="row no-margin">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    ...
                                    <a href="<?php echo e(route('provider.profile.index')); ?>" class="new-pro-link">My Profile</a>
                                </div>
                            </li>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo e(route('provider.change.password')); ?>">Change Password</a></li>
                            <li>
