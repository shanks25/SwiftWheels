    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="<?php echo e(url('contacts')); ?>">Help</a>
                </li>
                <li>
                ...
                <nav class="navbar navbar-fixed-top">
                    <div class="container-fluid" style="background-color:#660066;">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">  <img src="<?php echo e(asset('logo.png')); ?>"  > </a>
                        </div>
                        <div class="collapse navbar-collapse"  id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="<?php echo e(url('contacts')); ?>">Help</a></li>
                        ...
                        <div class="row no-margin">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(url('contacts')); ?>">Cities</a></li>
                                    <li><a href="<?php echo e(url('contacts')); ?>">Contact us</a></li>
                                </ul>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <ul>
