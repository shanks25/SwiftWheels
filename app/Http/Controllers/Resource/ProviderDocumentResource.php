...
class ProviderDocumentResource extends Controller
{
    ...
    public function index(Request $request, $provider)
    {
        try {
            ...
            $providerRides = ProviderRide::where('provider_id', $provider)->get();
            $ProviderService = ProviderService::where('provider_id', $provider)->with('service_type')->get();
            $ServiceTypes = ServiceType::all();
            $VehicleType = VehicleType::all();

            $rideTypes = RideType::all();
            return view('admin.providers.document.index', compact('Provider', 'ServiceTypes', 'ProviderService', 'providerRides', 'rideTypes', 'VehicleType'));
