...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            //ksr code
              if($request->has('destinationname')) 
                $Provider->destinationname = $request->destinationname;
              ...
              if($request->has('sourcename')) 
                $Provider->sourcename = $request->sourcename;

              if($request->has('slongitude')) 
                $Provider->slongitude = $request->slongitude;

              if($request->has('slatitude')) 
                $Provider->slatitude = $request->slatitude;

            if($request->has('iscoperate')) 
                $Provider->iscoperate = $request->iscoperate;
    ...
    public function target(Request $request)
    {
     ...
     public function servicelist()
     {
      ...
      public function updateservice(Request $request)
      {
           ...
           $service = ProviderService::where('provider_id',Auth::user()->id)->first();
